...
public class Client {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            System.out.println("6. View customer purchases by store");
            ...
            if (option.equals("1")) {
                ...
                try {
                    ...
                    if (response instanceof HashMap) {
                        ...
                        HashMap<String, Integer> purchases = (HashMap<String, Integer>) response;
                        if (purchases.isEmpty()) {
                            ...
                            for (Map.Entry<String, Integer> entry : purchases.entrySet()) {
                                ...
                                System.out.printf("- %s x%d (%.2f€)%n", productName, quantity);
                            }
