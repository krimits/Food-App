    ...
    private static int extractIntValue(String json, String key) {
        ...
        if (matcher.find()) {
            try {
                ...
                System.err.println("ClientJsonUtil: NumberFormatException for key '" + key + "' - value: '" + matcher.group(1) + "'. Returning 0.");
            }
        }
        return 0; 
    }
    ...
    private static double extractDoubleValue(String json, String key) {
        ...
        if (matcher.find()) {
            try {
                ...
                System.err.println("ClientJsonUtil: NumberFormatException for key '" + key + "' - value: '" + matcher.group(1) + "'. Returning 0.0.");
            }
        }
        return 0.0; 
    }
